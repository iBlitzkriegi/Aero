        ...
        if(message.getContent().startsWith(Settings.getCommandStart())){
            ...
            if(args[0].equalsIgnoreCase("joinserver")) {
                if (!muted.contains(message.getAuthor().getId())) {
                    ...
                    builder.append("Have a moderator use my invite link " + message.getAuthor().getMentionTag() + "!").appendNewLine().append("https://discordapp.com/oauth2/authorize?client_id=174348223908020235&scope=bot&permissions=66186303");
